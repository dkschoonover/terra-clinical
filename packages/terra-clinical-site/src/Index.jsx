...
import SearchBarExamples from './examples/search-bar/Index';
...
import SearchBarTestRoutes from 'terra-clinical-search-bar/tests/nightwatch/SearchBarTestRoutes';
...
ReactDOM.render((
  <Router history={hashHistory}>
    ...
    <Route path="/site" component={App}>
      ...
      <Route path="search-bar" component={SearchBarExamples} />
    </Route>
